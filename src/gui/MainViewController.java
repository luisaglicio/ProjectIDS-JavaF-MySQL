...
public class MainViewController implements Initializable {
	...
	@FXML
	private MenuItem menuItemNotasFaltas;
	...
	@FXML
	public void onMenuItemNotasFaltasAction() {
		loadView("/gui/NotasFaltasList.fxml", (NotasFaltasListController controller) -> {
			controller.setNotasFaltasService(new NotasFaltasService());
